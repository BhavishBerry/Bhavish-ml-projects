"""
Cat vs Dog Classifier - Theme 3 (Minimal Mono)
...
st.markdown(
    ...
    .result-box {
        background-color: #f4f4f4; border: 1px solid #111111;
        border-radius: 4px; padding: 1.2rem; text-align: center;
        margin-top: 1rem;
    }
    .result-box h2 { color: #111111 !important; }
    [data-testid="stFileUploaderDropzone"] {
        background-color: #f4f4f4; border: 1px dashed #111111;
    }
    </style>
    """,
