"""
Cat vs Dog Classifier - Theme 1 (Midnight Neon)
...
st.markdown(
    """
    <style>
    .stApp { background-color: #0f0f1a; color: #e8e8f5; }
    h1, h2, h3, p, label, .stMarkdown { color: #e8e8f5 !important; }
    .stButton>button {
        background-color: #00ffd5; color: #0f0f1a; border: none;
        border-radius: 8px; font-weight: 700;
    }
    .result-box {
        background-color: #1a1a2e; border: 1px solid #00ffd5;
        border-radius: 12px; padding: 1.2rem; text-align: center;
        margin-top: 1rem;
    }
    .result-box h2 { color: #00ffd5 !important; }
    [data-testid="stFileUploaderDropzone"] {
        background-color: #1a1a2e; border: 1px dashed #00ffd5;
    }
    </style>
    """,
